...
var dialog = $.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		// dialog in IE (#9312)
        this.uiDialogTitlebarClose = $("<button type='button' style='border:none;font-size:14pt'><i class='far fa-window-close'></i></button>")
			.button({
            ...
            .addClass( "ui-dialog-titlebar-close far fa-window-close" )
