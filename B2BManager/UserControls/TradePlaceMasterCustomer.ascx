<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TradePlaceMasterCustomer.ascx.vb" Inherits="UserControls_TradePlaceMasterCustomer" %>
...
<div style="display: inline-block;">
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="TradePlaceMasterCustomerPanel" Class="TradePlaceCustomerPanel" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <div style="position: absolute; top: 0; width: 100%; height: 100%; align-content: center; vertical-align: middle;">
                <asp:DataList ID="dtlTPMasterCustomer" runat="server" Style="width: 370px; height: 500px; overflow: auto; display: inline-block;">
                ...
                <ItemTemplate>
                    <input id="hidID" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "MasterCode")%>' name="ID" runat="server">
                    <a onclick="javascript:__doPostBack('TradePlaceCustomer','<%# DataBinder.Eval(Container.DataItem, "MasterCode") %>');LineClick($(this));"><%# DataBinder.Eval(Container.DataItem, "MasterName")%> </a>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="dtlTPMasterCustomer" />
        </Triggers>
    </asp:UpdatePanel>
</div>
<script>
