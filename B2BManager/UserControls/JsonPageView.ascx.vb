...
Partial Class UserControls_JsonPageView
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not String.IsNullOrEmpty(_html) And Not String.IsNullOrEmpty(_sessionName) Then
            divJSONFile.InnerHtml = _html
            BtnViewReplyInBrowser.Attributes.Add("onclick", "popup('GetJSONFile.ashx?file=" + _sessionName + "')")
            BtnDownloadReplyXML.Attributes.Add("onclick", "donwloadJSON('" + _sessionName + "')")
            BtnCopyReply.Attributes.Add("data-clipboard-target", "#" & divJSONFile.UniqueID.Replace("$", "_").Replace("ctl00_", ""))
