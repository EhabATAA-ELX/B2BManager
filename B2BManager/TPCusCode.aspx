<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TPCusCode.aspx.vb" Inherits="TPCusCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:updatepanel runat="server" UpdateMode="Conditional" ID="CusCodePanel" Class="EANPanel" ChildrenAsTriggers="false">
        <ContentTemplate>
            <asp:Panel runat="server" ID="PanelDetailCustomer" Visible="false" CssClass="PanelDetailCustomer">
                ...
                <asp:Panel runat="server" ID="PanelAddCUSOEM" Visible="false">
                ...
                <table>
                  ...
                  <asp:DataList id="dtlTPCustomerCusCode" runat="server" Width="100%" GridLines="None" ShowHeader="True"
											...
											<ItemTemplate>
                                                        <td>
                                                            <%#Container.DataItem("C_CUS")%>
                                                        </td>
                                                        <td>
                                                            <%#Container.DataItem("C_CUID")%>
                                                        </td>
                                                        <td>
                                                            <asp:ImageButton ID="BtnDelete" runat="server" Text="Delete" ToolTip="Delete" ImageUrl="./Images/delete.png" OnCommand="BtnDelete_Click" Visible="true" UseSubmitBehavior="false" CommandArgument='<%#Container.DataItem("C_CUS") + "," + Container.DataItem("C_CUID") %>' Height="20" Width="20"/>
                                                        </td>											
                                            </ItemTemplate>
                       <FooterTemplate>
                            <td colspan="3" style="text-align: center;">                                
                                <asp:Label Visible='<%#Boolean.Parse((dtlTPCustomerCusCode.Items.Count = 0).ToString())%>' runat="server" ID="lblNoRecord" Text="No Record Found!"></asp:Label>
                            </td>
                        </FooterTemplate>
				    </asp:DataList>                                      
            </asp:Panel>
