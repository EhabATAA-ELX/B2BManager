<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TPGlnCode.aspx.vb" Inherits="TPGlnCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:updatepanel runat="server" UpdateMode="Conditional" ID="EANCodePanel" Class="EANPanel" ChildrenAsTriggers="false">
        <ContentTemplate>
            <asp:Panel runat="server" ID="PanelDetailCustomer" Visible="false" CssClass="PanelDetailCustomer">
                ...
                <asp:Panel runat="server" ID="PanelAddEANOEM" Visible="false">
                ...
                <table>
                    ...
                    <tr>
                        <td><asp:TextBox runat="server" ID="txtEAN"></asp:TextBox></td>
                        <td><asp:TextBox runat="server" ID="txtOEM"></asp:TextBox></td>                        
                    </tr>
                    <tr>
                        <td><asp:RequiredFieldValidator ID="txtEANValidator" runat="server" ErrorMessage="EAN cannot be blank" ControlToValidate="txtEAN" ForeColor="Red" ValidationGroup="NewValueValidation"></asp:RequiredFieldValidator></td>
                  ...
                  <asp:DataList id="dtlTPCustomerEANCode" runat="server" Width="100%" GridLines="None" ShowHeader="True" AutoGenerateColumns="False">
							...
							<ItemTemplate>
                                        <td>
                                            <%#Container.DataItem("C_EAN")%>
                                        </td>
                                        <td>
                                            <%#Container.DataItem("C_CUID")%>
                                        </td>
                                        <td>
                                            <asp:ImageButton  ID="BtnDelete" runat="server" Text="Delete" ToolTip="Delete" ImageUrl="./Images/delete.png" OnCommand="BtnDelete_Click" Visible="true" UseSubmitBehavior="false" CommandArgument='<%#Container.DataItem("C_EAN") + "," + Container.DataItem("C_CUID") %>' Height="20" Width="20"/>
                                        </td>												
                            </ItemTemplate>  
                        <FooterTemplate>
                            <td colspan="3" style="text-align: center;">   
                                <asp:Label Visible='<%#Boolean.Parse((dtlTPCustomerEANCode.Items.Count = 0).ToString())%>' runat="server" ID="lblNoRecord" Text="No Record Found!"></asp:Label>
                            </td>
                        </FooterTemplate>
