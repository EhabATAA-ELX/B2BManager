<%@ Page Title="" Language="VB" MasterPageFile="~/BasicMasterPage.master" AutoEventWireup="false" 
    CodeFile="FocusRangeAssignment.aspx.vb" Inherits="FocusRangeAssignment" %>
    ...
    <asp:PlaceHolder runat="server" ID="ManagementScript" Visible="false">
        <script type="text/javascript">
            ...
            function ManageSelection(type, btn) {
                ...
                var data = { Type: type, Values: values <%= GetComplementaryInfo() %>};

                $.ajax({
                    type: 'POST',
                    url: 'B2BManagerService.svc/ManageFocusRangeCustomersList',
